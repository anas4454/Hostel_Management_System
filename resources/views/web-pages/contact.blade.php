<x-web-component.main>
    ...
    <section class="contact-section py-5"  style="background-color: #efe9e1;">
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                ...
                <!-- LEFT -->
                <div class="col-lg-6">
                    <span class="badge-soft mb-3">🌿 Get In Touch</span>
