		...
		<div class="card-box mb-4">
			...
			<div class="row g-4">
				<div class="col-md-4 text-center ">
					...
					<h6 class="mt-5">Student Name</h6>
					<p class="text-muted mt-2">Roll No: 123456</p>
				</div>
				<div class="col-md-8">
					<div class="card-box p-4">
						<h6>Personal Information</h6>
						<ul class="list">
							<li>Email: student@email.com</li>
							<li>Phone: 0300-1234567</li>
						</ul>
						<button class="btn btn-outline-success mt-2">Edit Profile</button>
					</div>
				</div>
			</div>
		</div>
